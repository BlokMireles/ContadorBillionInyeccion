...
namespace Contador
{
    public partial class ImpScrap2 : Form
    {
        ...
        {
            if (CmbImpresoras2.Text == string.Empty)
            {
                Validacion2.SetHighlightColor(CmbImpresoras2, DevComponents.DotNetBar.Validator.eHighlightColor.Red);
            }
            else
            {
                Validacion2.SetHighlightColor(CmbImpresoras2, DevComponents.DotNetBar.Validator.eHighlightColor.Green);
            }
        }
        public void nomas()
        {
        ...
        public void Excel()
        {
            ...
            x.Cells[add, 3] = form1.LblMaquina2.Text;
            x.Cells[add, 4] = form1.LblPieza2.Text;
            if (CadS1.Text != "0")
            {
        ...
        private void ImpScrap2_Load(object sender, EventArgs e)
        {
            CadS1.Text = (string)Settings.Default["CadSLH1"];
            CadS2.Text = (string)Settings.Default["CadSLH2"];
            CadS3.Text = (string)Settings.Default["CadSLH3"];
            CadS4.Text = (string)Settings.Default["CadSLH4"];
            CadS5.Text = (string)Settings.Default["CadSLH5"];
            CadS6.Text = (string)Settings.Default["CadSLH6"];
            TpS1.Text = (string)Settings.Default["TpSLH1"];
            TpS2.Text = (string)Settings.Default["TpSLH2"];
            TpS3.Text = (string)Settings.Default["TpSLH3"];
            TpS4.Text = (string)Settings.Default["TpSLH4"];
            TpS5.Text = (string)Settings.Default["TpSLH5"];
            TpS6.Text = (string)Settings.Default["TpSLH6"];
            Validacion2.SetHighlightColor(CmbImpresoras2, DevComponents.DotNetBar.Validator.eHighlightColor.Red);
        ...
        {
            Settings.Default["CadSLH1"] = CadS1.Text;
        ...
        {
            Settings.Default["CadSLH2"] = CadS1.Text;
        ...
        {
            Settings.Default["CadSLH3"] = CadS3.Text;
        ...
        {
            Settings.Default["CadSLH4"] = CadS4.Text;
        ...
        {
            Settings.Default["CadSLH5"] = CadS5.Text;
        ...
        {
            Settings.Default["CadSLH6"] = CadS6.Text;
